<script>
  ...
  $: formattedPrice = pack ? new Intl.NumberFormat('ja-JP').format(pack.price) : '0';
  ...
  <article class="py-10 md:py-16">
    <div class="grid grid-cols-1 items-start gap-12 lg:grid-cols-2">
      ...
      <Reveal as="div" extraClass="flex flex-col" delay={60}>
        <nav class="mb-6 text-[10px] uppercase tracking-[0.28em] text-stone-400">
        ...
        <div class="mt-8 space-y-8">
          ...
          <div class="rounded border border-stone-200 bg-stone-50/70 p-5">
            <h3 class="mb-4 flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.22em] text-stone-800">
          ...
          <div class="pt-2">
            <h3 class="mb-4 text-[11px] font-bold uppercase tracking-[0.22em]">ボックスの内容</h3>
            <ul class="space-y-3">
          ...
          <div class="rounded border border-stone-100 bg-stone-50 p-6">
            <h3 class="mb-4 text-[10px] font-bold uppercase tracking-[0.28em] text-stone-400">
              特定原材料（アレルギー）
            </h3>
...
{:else}
  <div class="py-24 text-center">
    <p class="text-sm tracking-wide text-stone-500">読み込み中…</p>
  </div>
{/if}
